package pl.filebit.grafik.ui.theme
 ...
 * Wartości pochodzą 1:1 z makiet w design/mockups/*.html — NIE ZMIENIAĆ.
...
// ─────────────────────────────────────────────────────────────
enum class DayKind { I, II, III, URLOP, WOLNE, POZA }
...
object ShiftPaletteDark {
    ...
    fun of(kind: DayKind) = when (kind) {
        DayKind.I -> I; DayKind.II -> II; DayKind.III -> III
        DayKind.URLOP -> URLOP; DayKind.WOLNE -> WOLNE; DayKind.POZA -> POZA
    }
}
